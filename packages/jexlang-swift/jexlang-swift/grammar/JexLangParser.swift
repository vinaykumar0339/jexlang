...
open class JexLangParser: Parser {
	...
	enum Tokens: Int {
		case EOF = -1, T__0 = 1, LET = 2, CONST = 3, GLOBAL = 4, BOOLEAN = 5, 
                 ...
                 LT = 27, GT = 28, LPAREN = 29, RPAREN = 30, LBRACE = 31, 
                 RBRACE = 32, LBRACKET = 33, RBRACKET = 34, SEMICOLON = 35, 
                 COMMA = 36, DOT = 37, PIPE = 38, QUESTION = 39, COLON = 40, 
                 NUMBER = 41, IDENTIFIER = 42, STRING = 43, WS = 44, LINE_COMMENT = 45, 
                 BLOCK_COMMENT = 46
	}
	...
	@discardableResult
	 open func program() throws -> ProgramContext {
		...
		do {
		 	...
		 	_la = try _input.LA(1)
		 	while (((Int64(_la) & ~0x3f) == 0 && ((Int64(1) << _la) & 15438803119614) != 0)) {
		 		setState(34)
		 		try statement()
	...
	@discardableResult
	 open func arrayLiteral() throws -> ArrayLiteralContext {
		...
		do {
		 	...
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	if (((Int64(_la) & ~0x3f) == 0 && ((Int64(1) << _la) & 15404443381218) != 0)) {
		 		setState(207)
		 		try arrayElement()
		 		setState(212)
		 		try _errHandler.sync(self)
	...
	@discardableResult
	 open func objectLiteral() throws -> ObjectLiteralContext {
		...
		do {
		 	...
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	if (((Int64(_la) & ~0x3f) == 0 && ((Int64(1) << _la) & 15401752723524) != 0)) {
		 		setState(222)
		 		try objectProperty()
		 		setState(227)
		 		try _errHandler.sync(self)
	...
	@discardableResult
	 open func objectPropertyName() throws -> ObjectPropertyNameContext {
		...
		do {
		 	...
		 	setState(247)
		 	_la = try _input.LA(1)
		 	if (!(((Int64(_la) & ~0x3f) == 0 && ((Int64(1) << _la) & 15393162788932) != 0))) {
		 	try _errHandler.recoverInline(self)
		 	}
		 	else {
		 		_errHandler.reportMatch(self)
	...
	static let _serializedATN:[Int] = [
		...
		22,24,26,28,30,32,0,9,1,0,2,3,1,0,10,11,2,0,1,1,13,13,1,0,21,22,2,0,12,
		12,26,26,1,0,23,25,2,0,16,17,27,28,1,0,14,15,3,0,2,2,6,6,41,43,306,0,37,
		1,0,0,0,2,46,1,0,0,0,4,48,1,0,0,0,6,57,1,0,0,0,8,60,1,0,0,0,10,71,1,0,
		0,0,12,75,1,0,0,0,14,115,1,0,0,0,16,196,1,0,0,0,18,204,1,0,0,0,20,206,
		1,0,0,0,22,219,1,0,0,0,24,221,1,0,0,0,26,245,1,0,0,0,28,247,1,0,0,0,30,
		249,1,0,0,0,32,267,1,0,0,0,34,36,3,2,1,0,35,34,1,0,0,0,36,39,1,0,0,0,37,
		35,1,0,0,0,37,38,1,0,0,0,38,40,1,0,0,0,39,37,1,0,0,0,40,41,5,0,0,1,41,
		1,1,0,0,0,42,47,3,10,5,0,43,47,3,8,4,0,44,47,3,4,2,0,45,47,3,6,3,0,46,

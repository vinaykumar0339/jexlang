...
public class JexLangParser extends Parser {
	...
	public static final int
		...
		POWER=26, LT=27, GT=28, NOT=29, LPAREN=30, RPAREN=31, LBRACE=32, RBRACE=33, 
		LBRACKET=34, RBRACKET=35, SEMICOLON=36, COMMA=37, DOT=38, PIPE=39, QUESTION=40, 
		COLON=41, NUMBER=42, IDENTIFIER=43, STRING=44, WS=45, LINE_COMMENT=46, 
		BLOCK_COMMENT=47;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"MODULO", "POWER", "LT", "GT", "NOT", "LPAREN", "RPAREN", "LBRACE", "RBRACE", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 30878136806910L) != 0)) {
				{
				{
				setState(34);
				statement();
	...
	public static class UnaryExpressionContext extends SingleExpressionContext {
		...
		public TerminalNode NOT() { return getToken(JexLangParser.NOT, 0); }
	...
	public final ArrayLiteralContext arrayLiteral() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 30809417330146L) != 0)) {
				{
				setState(207);
				arrayElement();
				setState(212);
	...
	public final ObjectLiteralContext objectLiteral() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 30803505446980L) != 0)) {
				{
				setState(222);
				objectProperty();
				setState(227);
	...
	public final ObjectPropertyNameContext objectPropertyName() throws RecognitionException {
		...
		try {
			...
			setState(247);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 30786325577796L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
